...
menu = st.sidebar.radio('Options', ['About Us','Encode', 'Decode'])

if menu == 'About Us':
    st.title('DPS Project')
    st.write('Team Members:   ')
    st.write('Indhu Sree S 1832023')
    st.write('Vaishnavi K 1832058')
    st.title('Project Title')
    st.write('Combined use of Steganography and Visual Cryptography for Secured Data hiding ')
